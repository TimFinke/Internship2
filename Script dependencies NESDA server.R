...
"make_supp_data" <- function(modelname, meta = TRUE,
  ...
  if(meta == TRUE){
    ...
    list_of_datasets2 <- list("Model 0 NTR FDR05" = model0$fdr_05_NTR,
                              ...
                              "Model 0 NESDA FDR05" = model0$fdr_05_NTR,
                              "Model 0 NESDA FDR10" = model0$fdr_1_NTR,
                              ...
                              "Model 1 NESDA FDR05" = model1$fdr_05_NTR,
                              "Model 1 NESDA FDR10" = model1$fdr_1_NTR,
                              ...
                              "Model 2 NESDA FDR05" = model2$fdr_05_NTR,
                              "Model 2 NESDA FDR10" = model2$fdr_1_NTR,
